...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_4x6(
        ...
        KC_LSFT, KC_A, KC_S, KC_D, KC_F, KC_G, KC_MUTE,       DRGSCRL, KC_H, KC_J, KC_K,   KC_L,   KC_SCLN, KC_QUOT,
    ...
    [_LOWER] = LAYOUT_4x6(
        ...
        _______,KC_HOME,KC_PGUP,KC_PGDN,KC_END ,KC_LPRN, KC_MUTE,      DRGSCRL, KC_RPRN, KC_P4 , KC_P5 , KC_P6 ,KC_MINS,KC_PIPE,
    ...
    [_RAISE] = LAYOUT_4x6(
        ...
        _______,KC_LEFT,KC_UP,KC_DOWN,KC_RGHT,KC_LPRN, KC_MUTE,        DRGSCRL, KC_RPRN,KC_MPRV,KC_MPLY,KC_MNXT,_______,KC_VOLU,
